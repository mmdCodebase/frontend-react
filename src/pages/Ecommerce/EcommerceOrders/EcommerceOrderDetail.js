              ...
              <CardHeader>
                <div className="d-sm-flex align-items-center">
                  ...
                  <div className="flex-shrink-0 mt-2 mt-sm-0">
                    <Link
                      to="#"
                      className="btn btn-soft-info btn-sm mt-2 mt-sm-0 shadow-none"
                    >
                    ...
                    <Link
                      to="#"
                      className="btn btn-soft-danger btn-sm mt-2 mt-sm-0 shadow-none"
                    >
                    ...
                    <div className="accordion-item border-0">
                      <div className="accordion-header" id="headingFour">
                        ...
                        >
                          <div className="d-flex align-items-center">
                            <div className="flex-shrink-0 avatar-xs">
                              <div className="avatar-title bg-light text-success rounded-circle shadow">
