                            ...
                            <div className="acitivity-item py-3 d-flex">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <div className="avatar-group mb-2">
                                        <Link to="#" className="avatar-group-item shadow" id="Christi">
                                        ...
                                        <Link to="#" className="avatar-group-item shadow" id="Frank">
                                            <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                        </Link>
                                        <UncontrolledTooltip placement="top" target="Frank" > Frank Hook </UncontrolledTooltip>

                                        <Link to="#" className="avatar-group-item shadow" id="Ruby">
                                        ...
                                        <Link to="#" className="avatar-group-item shadow" id="more">
                                            <div className="avatar-xs">
                            ...
                            <div className="acitivity-timeline p-4">
                                ...
                                <div className="acitivity-item py-3 d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <p className="text-muted mb-2"><i className="ri-file-text-line align-middle ms-2"></i> Create new project Buildng product</p>
                                        <div className="avatar-group mb-2">
                                            <Link to="#" className="avatar-group-item shadow" title="" id="Christi">
                                                <img src={avatar4} alt="" className="rounded-circle avatar-xs" />
                                            </Link>
                                            <UncontrolledTooltip placement="top" target="Christi" > Christi </UncontrolledTooltip>

                                            <Link to="#" className="avatar-group-item shadow" title="" id="Frank">
                                                <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                            </Link>
                                            <UncontrolledTooltip placement="top" target="Frank" > Frank Hook </UncontrolledTooltip>

                                            <Link to="#" className="avatar-group-item shadow" title="" id="Ruby">
                                                <div className="avatar-xs">
                                                    <div className="avatar-title rounded-circle bg-light text-primary">
                                                        R
                                                    </div>
                                            ...
                                            <Link to="#" className="avatar-group-item shadow" title="" id="more">
                                                <div className="avatar-xs">
                                                    <div className="avatar-title rounded-circle">
                                                        2+
                                                    </div>
