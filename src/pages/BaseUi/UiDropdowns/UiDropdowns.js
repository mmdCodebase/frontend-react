                                        ...
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="primary" className="shadow-none">Primary</Button>
                                                    <DropdownToggle tag="button" className="btn btn-primary shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="success" className="shadow-none">Success</Button>
                                                    <DropdownToggle tag="button" className="btn btn-success shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="light" className="shadow-none">Light</Button>
                                                    <DropdownToggle tag="button" className="btn btn-light shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="info" className="shadow-none">Info</Button>
                                                    <DropdownToggle tag="button" className="btn btn-info shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="secondary" className="shadow-none">Secondary</Button>
                                                    <DropdownToggle tag="button" className="btn btn-secondary shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="warning" className="shadow-none">Warning</Button>
                                                    <DropdownToggle tag="button" className="btn btn-warning shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="danger" className="shadow-none">Danger</Button>
                                                    <DropdownToggle tag="button" className="btn btn-danger shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="dark" className="shadow-none">Dark</Button>
                                                    <DropdownToggle tag="button" className="btn btn-dark shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3 align-items-center">
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="light" className="btn-lg shadow-none">Large split button</Button>
                                                    <DropdownToggle tag="button" className="btn btn-light btn-lg shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="light" className="btn-sm shadow-none">Small split button</Button>
                                                    <DropdownToggle tag="button" className="btn btn-light btn-sm shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            ...
                                            <ButtonGroup className="shadow">
                                                <UncontrolledButtonDropdown>
                                                    <Button color="secondary" className="shadow-none">Reference</Button>
                                                    <DropdownToggle tag="button" className="btn btn-secondary shadow-none" id="dropdownMenuReference" split>
