                                        ...
                                        <div>
                                            <div>
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded shadow" alt="rounded" />
                                                        <p><code>.rounded</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-top shadow" alt="rounded-top" />
                                                        <p><code>.rounded-top</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-end shadow" alt="rounded-end" />
                                                        <p><code>.rounded-end</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-bottom shadow" alt="rounded-bottom" />
                                                        <p><code>.rounded-bottom</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-start shadow" alt="rounded-start" />
                                                        <p><code>.rounded-start</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-circle shadow" alt="rounded-circle" />
                                                    ...
                                                    <div className="text-center">
                                                        <img src={img2}
                                                            className="avatar-md w-auto rounded-pill shadow" alt="rounded-pill" />
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-0 shadow" alt="rounded-0" />
                                                        <p><code>.rounded-0</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-1 shadow" alt="rounded-1" />
                                                        <p><code>.rounded-1</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-2 shadow" alt="rounded-2" />
                                                        <p><code>.rounded-2</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-3 shadow" alt="rounded-3" />
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="vstack gap-3">
                                            <div className="bg-light border p-1 px-2 shadow">First item</div>
                                            <div className="bg-light border p-1 px-2 shadow">Second item</div>
                                            <div className="bg-light border p-1 px-2 shadow">Third item</div>
                                        </div>
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="vstack gap-2 col-md-5 mx-auto">
                                                ...
                                                <Button color="secondary" outline className="shadow-none">Cancel</Button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="hstack gap-3">
                                                <div className="bg-light border p-1 px-2 shadow">First item</div>
                                                <div className="bg-light border p-1 px-2 shadow ms-auto">Second item</div>
                                                <div className="bg-light border p-1 px-2 shadow">Third item</div>
                                            </div>
                                            <div className="hstack gap-3 mt-3">
                                                ...
                                                <div className="bg-light border p-1 px-2 shadow ms-auto">Third item</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="hstack gap-3">
                                                ...
                                                <div className="vr"></div>
                                                <Button className="shadow-none" color="secondary" outline>Reset</Button>
                                            </div>
                                        </div>
                                    </div>
