...
const UiProgress = () => {
    document.title = "Progress | Smart Shutter Website";
    return (
        <React.Fragment>
            <UiContent />
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            <Progress className="bg-soft-primary" value={0} />
                                        </div>
                                        <div className="mb-4">
                                            <Progress className="bg-soft-primary" value={25} />

                                        </div>
                                        <div className="mb-4">
                                            <Progress className="bg-soft-primary" value={50} />
                                        </div>
                                        <div className="mb-4">
                                            <Progress className="bg-soft-primary" value={75} />
                                        </div>
                                        <div>
                                            <Progress className="bg-soft-primary" value={100} />
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            <Progress className="bg-soft-primary" color="primary" value={15} />
                                        </div>
                                        <div className="mb-4">
                                            <Progress className="bg-soft-success" color="success" value={25} />
                                        </div>
                                        <div className="mb-4">
                                            <Progress className="bg-soft-info" color="info" value={50} />
                                        </div>
                                        <div className="mb-4">
                                            <Progress className="bg-soft-warning" color="warning" value={75} />
                                        </div>
                                        <div>
                                            <Progress className="bg-soft-danger" color="danger" value={100} />
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Progress className="bg-soft-primary" color="primary" value={25}> 25% </Progress>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <Progress className="bg-soft-primary" multi>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            ...
                                            <Progress color="primary" value={25} className="progress-sm bg-soft-primary" />
                                        </div>
                                        <div className="mb-4">
                                            <h5 className="fs-13">Default Progress </h5>
                                            <Progress color="success" value={40} className="progress-md bg-soft-success" />
                                        </div>
                                        <div className="mb-4">
                                            <h5 className="fs-13">Large Progress</h5>
                                            <Progress color="warning" value={50} className="progress-lg bg-soft-warning" />
                                        </div>
                                        <div>
                                            <h5 className="fs-13">Extra Large Progress</h5>
                                            <Progress color="danger" value={70} className="progress-xl bg-soft-danger" />
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            <Progress className="bg-soft-primary" striped value={25} />
                                        </div>
                                        <div>
                                            <Progress className="bg-soft-success" color="success" striped value={40} />
                                        </div>
                                    </div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <Progress className="bg-soft-primary" value={75} striped animated />
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            <Progress value={15} className="bg-gradient bg-soft-primary" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress color="success" value={25} className="bg-gradient bg-soft-success" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress color="info" value={50} className="bg-gradient bg-soft-info" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress color="warning" value={75} className="bg-gradient bg-soft-warning" />
                                        </div>
                                        <div>
                                            <Progress color="danger" value={100} className="bg-gradient bg-soft-danger" />
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="mb-4">
                                            <Progress value={15} className="animated-progess bg-soft-primary" />

                                        </div>
                                        <div className="mb-4">
                                            <Progress value={25} color="success" className="animated-progess bg-soft-primary" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress value={50} color="info" className="animated-progess bg-soft-primary" />
                                        </div>
                                        <div className="mb-4">
                                            <Progress value={75} color="warning" className="animated-progess bg-soft-primary" />
                                        </div>
                                        <div>
                                            <Progress value={100} color="danger" className="animated-progess bg-soft-primary" />
                                        </div>
                                    </div>
