                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="hstack gap-2 flex-wrap">
                                            ...
                                            <Label className="btn btn-outline-primary shadow-none" for="btn-check-outlined">Single toggle</Label>
                                            ...
                                            <Label className="btn btn-outline-danger shadow-none" for="danger-outlined">Danger radio</Label>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ "height": "275px" }}>
