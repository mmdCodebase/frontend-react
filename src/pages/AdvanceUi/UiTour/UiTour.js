...
const UiTour = () => {
    document.title = "Tour | Smart Shutter Website";
    return (
        <React.Fragment>
                                                            ...
                                                            <Card className="border">
                                                                <CardBody className="text-center">
                                                                    <div className="avatar-md mx-auto mb-4" id="register-tour">
                                                                        <div className="avatar-title bg-light rounded-circle text-primary fs-24 shadow">
                                                            ...
                                                            <Card className="border">
                                                                <CardBody className="text-center">
                                                                    <div className="avatar-md mx-auto mb-4" id="login-tour">
                                                                        <div
                                                                            className="avatar-title bg-light rounded-circle text-primary fs-24 shadow">
