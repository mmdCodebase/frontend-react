                                            ...
                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} className="simplebar-track-primary" style={{ maxHeight: "275px" }}>
                                                    ...
                                                    <Link to="#!" className="text-reset notification-item d-block dropdown-item active">
                                                        <div className="d-flex">
                                                            <div className="flex-shrink-0 avatar-xs me-3">
                                                                <img src={avatar2} className="rounded-circle img-fluid shadow" alt="user-pic" />
                                                            </div>
                                                            <div className="flex-grow-1 text-muted">
                                                    ...
                                                    <Link to="#!" className="text-reset notification-item d-block dropdown-item">
                                                        <div className="d-flex">
                                                            <div className="flex-shrink-0 avatar-xs me-3">
                                                                <img src={avatar8} className="rounded-circle img-fluid shadow" alt="user-pic" />
                                                            </div>
                                                            <div className="flex-grow-1 text-muted">
                                                            ...
                                                            <div className="d-flex align-items-start">
                                                                <div className="flex-shrink-0 align-self-center me-3">
                                                                    <div className="avatar-xs">
                                                                        <span className="avatar-title rounded-circle bg-light text-primary shadow">
                                                                            M
                                                                        </span>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} style={{ maxHeight: "220px" }} className="simplebar-track-warning px-3">
                                                    <div className="d-flex align-items-center py-3">
                                                        ...
                                                        <div className="flex-shrink-0 ms-2">
                                                            <Button className="shadow-none" color="success" size="sm" outline ><i className="ri-user-add-line align-middle"></i></Button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="d-flex align-items-center py-3">
                                                        <div className="avatar-xs flex-shrink-0 me-3">
                                                            <img src={avatar5} alt="" className="img-fluid rounded-circle shadow" />
                                                        </div>
                                                        <div className="flex-grow-1">
                                                            <div>
